  ...
  return (
    <div className='flex flex-col md:flex-row justify-center items-center mt-10 md:mt-20 gap-10 md:gap-20 bg-[#082f49] py-10'>
        <div className='w-[90%] md:w-[300px]'>
            ...
            <p className='text-gray-300 text-base'>At Tawon Legal Consular, we offer more than just services – we provide expert guidance tailored to your success. Navigate complexities, draft impactful contracts, and thrive with our dedicated support</p>
        </div>
