...
const Headline = () => {
  return (
    <div>
      ...
      <div className='h-full flex flex-col mx-auto justify-center w-[90%] items-center md:flex-row md:mt-[20vh]'>
        <div className='flex flex-col justify-center items-center md:w-[500px] mx-auto mt-10'>
          <h1 className='text-black text-2xl lg:text-4xl font-semibold mb-8'>Strategic Legal Solutions for Success - Tawon  Legal Services</h1>
          ...
          <button type='button' className='bg-custom-secondary-blue px-4 py-2 mt-2 rounded-full self-start'>Click Here</button>
        </div>
