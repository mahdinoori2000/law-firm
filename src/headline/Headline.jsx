    ...
    <div>
      <div className='h-full flex flex-col mx-auto justify-center w-[90%] items-center md:flex-row md:mt-[10vh]'>
        ...
        <div className='flex flex-col justify-center items-start md:w-[500px] mx-auto mt-10'>
          ...
          <p className='text-black text-[16px] font-normal mb-10'>Unlock tailored legal expertise at Cooperative Legal Services. From expert case management to precise contract drafting, our commitment is your success. Join us on your legal journey with a focus on quality and collaboration.</p>
          <button type='button' className='bg-custom-primary-blue text-white px-6 py-2 mt-2 self-start flex items-center gap-4'>Consult Our Experts</button>
        </div>
